 ...
 * mango4j-flowsink flow lifecycle.
 *
 ...
 * the controller method, it sets a web-flow marker on {@link ie.bitstep.mango.flowsink.core.FlowProcessorSupport} so
 ...
 *
 * @see FlowProcessor
 * @see ie.bitstep.mango.flowsink.spring.aspect.FlowAspect
 */
