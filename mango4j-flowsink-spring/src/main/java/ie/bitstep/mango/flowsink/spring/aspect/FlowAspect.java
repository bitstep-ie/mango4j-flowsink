package ie.bitstep.mango.flowsink.spring.aspect;
...
import ie.bitstep.mango.flowsink.annotations.OrphanAlert;
...
import ie.bitstep.mango.flowsink.spring.processor.AttributeParamExtractor;
import ie.bitstep.mango.flowsink.spring.processor.AttributeParamExtractor.AttrCtx;
...
public class FlowAspect {
	...
	@Around("@annotation(ie.bitstep.mango.flowsink.annotations.Flow) && execution(* *(..))")
	...
	@Around("@annotation(ie.bitstep.mango.flowsink.annotations.Step) && execution(* *(..))")
